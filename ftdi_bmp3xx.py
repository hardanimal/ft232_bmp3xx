...
class BMP3XX_I2C(BMP3XX):
    ...
    **Quickstart: Importing and using the BMP388**
    ...
    def __init__(self, address=0x77):
        ...
        self._ctl = I2cController()
        self._ctl.configure('ftdi://ftdi:232h/1')
        self._i2c = self._ctl.get_port(address)
        super().__init__()
...
class BMP3XX_SPI(BMP3XX):
    ...
    **Quickstart: Importing and using the BMP388**
    ...
    def __init__(self, cs=0):
        ...
        self._ctl = SpiController()
        self._ctl.configure('ftdi://ftdi:232h/1')
        self._spi = self._ctl.get_port(cs, freq=10E6, mode=0)
    ...
    def _read_register(self, register, length):
        ...
        result = self._spi.exchange(bytes((0x80 | register, 0x00)), length)
        return result
